"""
Example of PlanReAct agent usage with a simple task. All tools from an MCP
server are added to the toolbox. This example requires definition of the MCP
server in `.env` file, i.e.
